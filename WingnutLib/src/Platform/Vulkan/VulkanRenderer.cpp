...
namespace Wingnut
{
	...
	RendererData& VulkanRenderer::GetRendererData()
	{
		return s_VulkanData;
	}
	...
	std::vector<std::string> VulkanRenderer::FindInstanceLayers()
	{
	...
	std::vector<std::string> VulkanRenderer::FindInstanceExtensions()
	{
